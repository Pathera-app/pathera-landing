	...
	return (
		...
		>
			<div className="relative isolate z-0 flex w-full flex-1 scale-y-125 items-center justify-center">
				{/* Increased blur on the glow */}

				{/* Line element with higher z-index */}
				<motion.div
					initial={{ width: "8rem" }}
					...
					className="-translate-y-[6rem] absolute inset-auto z-30 h-36 w-64 rounded-full bg-blue-400 blur-[100px]"
				></motion.div>
				...
				<div className="absolute top-1/2 h-48 w-full translate-y-12 scale-x-150 blur-[8rem]"></div>
				<div className="absolute top-1/2 z-50 h-48 w-full bg-transparent opacity-10 backdrop-blur-md"></div>
				<div className="-translate-y-[12.5rem] absolute inset-auto z-40 h-44 w-full"></div>
			</div>
