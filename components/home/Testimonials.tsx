  ...
  return (
    <section className="bg-[#0B0F1A] py-12 sm:py-16 lg:py-20">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex w-full flex-col items-center justify-center space-y-4 sm:space-y-6">
        ...
        <div className="mx-auto max-w-6xl mt-8 sm:mt-12 lg:mt-16">
          <div className="grid grid-cols-1 gap-4 sm:gap-6 md:grid-cols-2 lg:grid-cols-3 lg:gap-8">
            {REVIEWS.map((review, index) => (
              <Card 
                key={index} 
                className="flex h-full flex-col border border-white/20 bg-black/20 p-4 sm:p-6"
              >
